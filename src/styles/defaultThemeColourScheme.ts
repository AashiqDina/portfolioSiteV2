import { WHITE, addAlpha, MUTED_BLUE, BLACK, DEFAULT_BOTTOM, DEFAULT_TOP, HOVER_PUPRLE_VARIANT_1, HOVER_PUPRLE_VARIANT_2, HOVER_PUPRLE_VARIANT_3, HOVER_PUPRLE_VARIANT_4, HOVER_PUPRLE_VARIANT_5, HOVER_PUPRLE_VARIANT_6, HOVER_PUPRLE_VARIANT_7 } from "./colours";
...
export const defaultTheme = {
    ...
    HeaderHoverColor7: HOVER_PUPRLE_VARIANT_7,
}